...
const Balance = () => {
  ...
  }, [exchange, tokens, account, transferInProgress, dispatch]) //remove dispatch (using to avoid lint error)
  ...
  return (
    <div className='component exchange__transfers'>
      ...
      <div className='exchange__transfers--form'>
        <div className='flex-between'>
          <p><small>Token</small><br /><img src={ethlogo} alt="Token Logo" width="20" height="21"/>{symbols && symbols[1]}</p>
